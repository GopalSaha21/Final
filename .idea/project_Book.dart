...
class Book {
  ...
  //eita static property jeita track korbe total book koto gulo...akhn kono book add nai tai suru te eita 0 dhore nilam....
  static int totalBooks = 0;

  // suru te pageRead 0 dhore rakhlam cz akhn o book add kora hoi nai......
...
void main() {
  ...
  // Jodi user exit na kore tahole eita run korbe.....
  while (!exit) {
    print('Options:');
    ...
    // eikhane user theke input neya hocche......//
